...
- [ ] 1. 音量レベル計算基盤の実装
- [ ] 1.1 (P) AudioCapturing プロトコルに音量レベルプロパティを追加する
...
- [ ] 1.2 AudioCaptureService でPCMバッファからRMS音量レベルを計算する
...
- [ ] 2. SessionManager への音量レベル公開機能の追加
- [ ] 2.1 SessionManager に audioLevel Published プロパティを追加する
...
- [ ] 3.2 FeedbackBarWindowController を実装する
...
- [ ] 4. 既存オーバーレイの置き換えと統合
- [ ] 4.1 KuchibiApp のオーバーレイ配線を新しいバー型インジケーターに切り替える
